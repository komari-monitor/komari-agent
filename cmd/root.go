...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&flags.AutoDiscoveryFile, "auto-discovery-file", "", "Path to the auto discovery state file (default: <executable dir>/auto-discovery.json)")
